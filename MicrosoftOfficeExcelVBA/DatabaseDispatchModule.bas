...
Sub runMongoDBServerSideApplication()
    ...
    If shellPIDdict.Exists("MongoDBServerSideApplication") Then
        ...
        codeScript = "C:/QuantitativeTrading/Data/MongoDB/Server/8.2/bin/mongod.exe --config=C:/QuantitativeTrading/Data/MongoDB/NodejsToMongoDB/mongod.cfg"  '開啓服務器的命令行控制臺 cmd 命令全名
