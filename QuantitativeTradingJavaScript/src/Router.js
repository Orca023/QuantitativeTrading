...
// const Interpolation = require('./Interpolation.js');  // 加載自定義算法模組;  // require(require('path').join(require('path').resolve("."), "Interpolation_Fitting.js")); require('path').resolve("..").toString().concat("/temp/"); 當加載自定義的模塊時，引用模塊需要包括路徑和模塊名的完整引用，只寫模塊名會報錯;
// const MathInterpolation = Interpolation.MathInterpolation;  // 使用「Interpolation.js」模塊中的成員「MathInterpolation(training_data, testing_data, Interpolation_Method, λ, k, d, h)」函數, 用於插值（Interpolation）運算;
