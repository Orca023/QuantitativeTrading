# # Base.string(Base.replace(Base.string(Base.Filesystem.joinpath(Base.string(Base.dirname(Base.Filesystem.abspath(Base.@__FILE__))), "Quantitative_Data_Cleaning.jl")), "\\" => "/"));  # C:/StatisticalServer/StatisticalServerJulia/Quantitative_Data_Cleaning.jl
...
# Julia_program_path::Core.String = Base.string(Base.replace(Base.string(Base.Filesystem.abspath(Base.PROGRAM_FILE)), "\\" => "/"));  # C:/StatisticalServer/StatisticalServerJulia/
# print(Julia_program_path, "\n");  # C:/StatisticalServer/StatisticalServerJulia/
# Julia_script_path::Core.String = Base.string(Base.replace(Base.string(Base.Filesystem.joinpath(Base.string(Base.Filesystem.abspath(Base.@__FILE__)), "Quantitative_Data_Cleaning.jl")), "\\" => "/"));  # C:/StatisticalServer/StatisticalServerJulia/src/Quantitative_Data_Cleaning.jl
