# # Base.string(Base.replace(Base.string(Base.Filesystem.joinpath(Base.string(Base.dirname(Base.abspath(Base.@__FILE__))), "Quantitative_Data_Cleaning.jl")), "\\" => "/"));  # C:/StatisticalServer/StatisticalServerJulia/Quantitative_Data_Cleaning.jl
# Julia_exe_path::Core.String = Base.string(Base.replace(Base.string(Base.Filesystem.joinpath(Base.string(Base.abspath(Base.Sys.BINDIR)), "julia.exe")), "\\" => "/"));  # C:/StatisticalServer/Julia/Julia-1.9.3/bin/julia.exe
# print(Julia_exe_path, "\n");  # C:/StatisticalServer/Julia/Julia-1.9.3/bin/julia.exe
# Julia_program_path::Core.String = Base.string(Base.replace(Base.string(Base.abspath(Base.PROGRAM_FILE)), "\\" => "/"));  # C:/StatisticalServer/StatisticalServerJulia/
# print(Julia_program_path, "\n");  # C:/StatisticalServer/StatisticalServerJulia/
# Julia_script_path::Core.String = Base.string(Base.replace(Base.string(Base.Filesystem.joinpath(Base.string(Base.abspath(Base.@__FILE__)), "Quantitative_Data_Cleaning.jl")), "\\" => "/"));  # C:/StatisticalServer/StatisticalServerJulia/src/Quantitative_Data_Cleaning.jl
# print(Julia_script_path, "\n");  # C:/StatisticalServer/StatisticalServerJulia/src/Quantitative_Data_Cleaning.jl
