...
# Julia_exe_path::Core.String = Base.string(Base.replace(Base.string(Base.Filesystem.joinpath(Base.string(Base.abspath(Sys.BINDIR)), "julia.exe")), "\\" => "/"));  # C:/StatisticalServer/Julia/Julia-1.9.3/bin/julia.exe
